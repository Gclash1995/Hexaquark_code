...
void Ex1_CLAS12Reader_edit4(){
  ...
  //ignore this just getting file name!
   ...
   auto* hBeta=new TH2F("hBeta","#Delta#beta (post PID)",100,0,3,100,-2,2);
   auto* hBeta1=new TH2F("hBeta1","#Delta#beta (pre PID)",100,0,3,100,-2,2);
